    ...
    >
      ...
      >
        <div className="flex items-center justify-between h-16">
          <Link href="/about-me" className="hover:text-gray-100 focus:ring-2 focus:ring-gray-400 focus:outline-none focus:ring-offset-2 focus:ring-offset-black rounded-sm p-2">
            About me
          </Link>
